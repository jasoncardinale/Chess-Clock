...
- Button depression is dampened by standard pen springs. Cut 4 springs in half and place each half around an M2 guide bolt (between the button and housing).

- There are shallow, circular imprints underneath the clock housing. Place small amounts of hot glue in these areas to prevent the clock from sliding.
